...
survey <- list( 
  questions =list(
  "Are you happy with our campus? Choose a number from 5(very happy), 4(happy), 3(satisfy), 2( unhappy), to 1(very unhappy).","Did you participate in any of the following activities? Check all that apply to you. (student association, school club, school sport team, department sport team)"
  ),
...
single_response <- list(
  questions=list(4,c("school club", "department sport team")
                 )
                        )
...
choice2 <- single_response$questions[[2]]
str(choice2)
str(survey$options[[2]][choice2])

survey$options[[1]][[choice1]]
survey$options[[2]][choice2]
...
responses <- list(
  student_1 = list(questions=list(4,c("school club", "department sport team"))), 
  student_2 = list(questions=list(3,NA)),
  student_3 = list(questions=list(5,c("student association", "school club", "school sport team")))
)
...
responses[[2]] <- NULL
responses[["student_1"]]$questions[[1]] <- 3
responses[["student_3"]]$questions[[1]] <- 3
# responses
```
...
```{r ans15}
responses_fbf <- list()
responses_fbf<- responses

list(question1=c(4,3,5),
     question2=list(c("school club", "department sport team",NA,c("student association", "school club", "school sport team"))),
     student_association=F,
     question2.school_club=,
     question2.school_sport_team,
     question2.department_sport_team
     )
